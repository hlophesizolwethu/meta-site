  ...
  const defaultTeam = [
    {
      ...
      bio: "Leading cybersecurity an AI expert with 2+ years experience in threat detection and AI-powered security solutions.",
      skills: ["AI Security", "Threat Detection", "Research Leadership", "Strategic Planning"],
      image_url: "/team/furman.jpg",
      linkedin_url: "#",
      email: "furmansimphiwe@gmail.com",
    },
    {
      id: "2",
